/*
 * Classic 5x7 bitmap font, ASCII 0x20..0x7E. One byte per column, bit 0 =
 * top row (the SSD1306 page layout). Characters are drawn 6 pixels apart.
 */
#pragma once
...
static const uint8_t oled_font5x7[][OLED_FONT_WIDTH] = {
...
_Static_assert(sizeof(oled_font5x7) / sizeof(oled_font5x7[0]) == OLED_FONT_LAST - OLED_FONT_FIRST + 1,
